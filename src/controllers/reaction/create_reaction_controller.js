import { createPostDocument, createPostReaction } from './_queries_reactions';
import { verifyAccessToken } from '../../helpers/token_helper';
const debug = require('debug')('app:post');

export const create_reaction = async (req, res, next) => {

  // post type: reaction => removed recommendations and top 10 for now...
  // media type: tv || movie
